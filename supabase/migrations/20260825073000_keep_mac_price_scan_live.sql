...
begin
  ...
  -- liveness reconciler closed while Supabase was timing out. It can also
  -- repair a non-VPS run that an older VPS-only reconciler closed by mistake.
  -- Saved or delayed local state keeps its old heartbeat and cannot reopen it.
